...
const APP_BASE_NAME = "T3 Code Kanban";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "t3code-kanban-dev" : "t3code-kanban";
  const legacyUserDataDirName = isDevelopment ? "T3 Code Kanban (Dev)" : "T3 Code Kanban";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.t3code.kanban.dev" : "com.t3tools.t3code.kanban",
    ),
