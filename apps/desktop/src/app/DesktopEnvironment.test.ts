...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.t3tools.t3code.kanban.dev");
      assert.equal(environment.linuxWmClass, "t3code-kanban-dev");
      assert.equal(
  ...
  it.effect("uses the stable desktop entry as the packaged Linux portal identity", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.linuxDesktopEntryName, "com.t3tools.T3CodeKanban.desktop");
    }),
  );
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.t3-kanban/dev");
      assert.equal(production.stateDir, "/Users/alice/.t3-kanban/userdata");
    }),
  );
