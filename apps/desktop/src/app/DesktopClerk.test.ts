...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "t3code-kanban-dev" : "t3code-kanban",
    legacyUserDataDirName: isDevelopment ? "T3 Code Kanban (Dev)" : "T3 Code Kanban",
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t3code-kanban-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/t3code-kanban-dev",
        "createClerkBridge",
      ]);
